...
if($entradaOK){
    ...
    try {
        ...
        $consulta->execute([
            ...
            ':passwd' => $_REQUEST['usuario'].$_REQUEST['password'] // como tu compañera concatena usuario+password
        ]);
        ...
        if(!$usuarioBD){
            ...
            $_SESSION['usuarioDAW202AppLoginLogoffTema5']=[
                ...
                'FechaHoraUltimaConexion' =>$oFechaActual,
